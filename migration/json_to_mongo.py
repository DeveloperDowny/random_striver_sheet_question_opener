...
# --- Configuration ---
config = Config(_env_file=r"/media/vedant/New Volume/DPythonProjects/roulette/.env")
...
JSON_FILES_TO_PROCESS: List[str] = [
    ...
    "data/multi_agents_design_pattern.json",
]
# --- Logging Setup ---
...
def process_json_file(file_path: str, db_client: MongoClient, db_name: str) -> None:
    ...
    try:
        ...
        collection: Collection = db["topics"]
        logging.info(
...
def main() -> None:
    ...
    for json_file in JSON_FILES_TO_PROCESS:
        try:
            ...
            base_path = Path(r"/media/vedant/New Volume/DPythonProjects/roulette")
